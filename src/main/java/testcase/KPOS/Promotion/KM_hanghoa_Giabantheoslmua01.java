...
public class KM_hanghoa_Giabantheoslmua01 extends AbstractPage {
    ...
    private String Khachcantra = "100,000";
    private String Tienkhachdua = "100,000";
...
//  Click chon KM hoadon_giamgiahang_tặng sản phẩm Barcode2
        kposPageObject.clickcheckBoxpromotion("Hàng hoá- Giá bán theo số lượng mua theo SL SP (AUTO TEST)");
