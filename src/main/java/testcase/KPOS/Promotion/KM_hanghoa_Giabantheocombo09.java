...
public class KM_hanghoa_Giabantheocombo09 extends AbstractPage {
    ...
    private String promotionText = "KM Hàng Hóa - Giá bán theo combo AUTOTEST combo 2/1 (giảm giá 25%)";

    // Gia tri khai bao cho web
    private String KhachcantraKP = "27.450";
    private String Tongsoluongsp = "4";
    private String Khachcantra = "27.450";
    private String Tienkhachdua = "27.000";
    private String giamtienle = "450";
