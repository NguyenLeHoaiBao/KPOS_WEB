...
public class KM_hanghoa_Giabantheocombo06 extends AbstractPage {
    ...
    private String promotionText = "KM Hàng Hóa - Giá bán theo combo AUTOTEST combo multi 2/2 (Giá bán+Giảm Giá)";

    // Gia tri khai bao cho web
    private String KhachcantraKP = "23.770";
    private String Tongsoluongsp = "4";
    private String Khachcantra = "23.770";
    private String Tienkhachdua = "23.000";
...
//  Click chon KM hoadon_giamgiahang_tặng sản phẩm Barcode2
        ...
        verifyItem.verifyPromotionText(Barcode8, promotionText);
