...
public class KM_hanghoa_Giabantheocombo08 extends AbstractPage {
    ...
    private String promotionText = "KM Hàng Hóa - Giá bán theo combo AUTOTEST combo 1/1 (giảm giá 15%)";

    // Gia tri khai bao cho web
    private String KhachcantraKP = "15.265";
    private String Tongsoluongsp = "2";
    private String Khachcantra = "15.265";
    private String Tienkhachdua = "15.000";
    private String giamtienle = "265";
