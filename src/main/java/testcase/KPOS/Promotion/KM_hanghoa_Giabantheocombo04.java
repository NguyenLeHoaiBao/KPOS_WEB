...
public class KM_hanghoa_Giabantheocombo04 extends AbstractPage {
    ...
    private String KhachcantraKP = "28.530";
    private String Tongsoluongsp = "4";
    private String Khachcantra = "28.530";
    private String Tienkhachdua = "28.000";
...
//  Click chon hop qua KM theo hoa don
        kposPageObject.clickLinePromo(Barcode7);
