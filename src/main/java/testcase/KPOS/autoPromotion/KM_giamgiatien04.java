...
public class KM_giamgiatien04 extends AbstractPage {
    ...
    private String Barcode1 = "1102727";
    private String Customer = "0938612787";
    private String CustomerOL = "210818694874416373";
    private String promotionText = "KM giam giá 5000 AUTO Khong gioi han";
    private String priceExpected = "294.000";
    private String priceItemline = "299,000";
    private String priceExpectedKDB = "294,000";
    ...
    @Test
    public void TC01_KM_giamgiatien_unlimit() throws InterruptedException {
